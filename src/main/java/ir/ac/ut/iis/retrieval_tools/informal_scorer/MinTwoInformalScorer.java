 ...
 * @author Shayan
 */
public class MinTwoInformalScorer extends InformalScorer {

    public MinTwoInformalScorer(String fileName) {
        super(fileName);
    }

    public MinTwoInformalScorer(List<ITerm> informalWords) {
        super(informalWords);
    }
